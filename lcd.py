...
def main(argv):
    ...
    draw.text((10, 80), "Detected People", fill = (128,255,128),font=Font1)
    ...
    with ImageImpulseRunner(modelfile) as runner:
        while True:
            ...
            if "classification" in res["result"].keys():
                ...
                for label in labels:
                    ...
                    if score > 0.5:
                        ...
                        draw.text((100, 120), label, fill = (128,255,128),font=Font1)
            ...
            sleep(5)
            image = Image.open('/home/pi/0022/pylepton-master/LCD_1inch28_2.jpg')	
